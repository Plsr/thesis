...
In der Komponente \textit{ColorsContainer} wir die Referenz der \verb|dispatch()| Methode als \verb|prop| mit dem Namen \verb|setBaseColors| an die Komponente \textit{Colors} übergeben (siehe dazu Listing zxc).
